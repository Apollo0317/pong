...
class SceneManager:
    def __init__(self, screen: pygame.Surface = None):
        ...
        self.bg = pygame.transform.scale(
            pygame.image.load("assets/fig/bg.png").convert(), self.screen.get_size()
        )
    ...
    def set_scene(self, scene: str = None, keep: bool = False, resume: bool = False):
        ...
        match scene:
            ...
            case "StopScene":
                ...
                cur_scene.set_bg(self.bg)
            case "GameOverScene":
                from pong.scene.GameOverScene import GameOverScene

                cur_scene = GameOverScene()
                cur_scene.set_bg(self.bg)
            case _:
    ...
    def update(self, dt, commands):
        if self.current_scene:
            self.current_scene.update(dt, commands)
